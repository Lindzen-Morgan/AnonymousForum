...
namespace AnonymousForum.Controllers
{
    public class RepliesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ThreadId,Title,Text,DateCreated")] Reply reply)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ThreadId,Title,Text,DateCreated")] Reply reply)
        {
            if (id != reply.Id)
            {
                return NotFound();
